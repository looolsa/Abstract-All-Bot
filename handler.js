        ...
        if (m.chat in global.db.data.chats || m.sender in global.db.data.users) {
          ...
          if (m.text && user.banned && !isROwner) {
            ...
            if (user.bannedMessageCount < 3) {
              ...
              const messageText = `❰ 💠 ❱ *Usuario Suspendio.*\nAviso ${messageNumber}/3 (${messageNumber} de 3)${user.bannedReason ? `\n*Motivo:* *${user.bannedReason}*` : ''}
*Te recomiendo contactar con el propietaria del Bot si crees que se trata de un error.*
`.trim();
        ...
        if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
          this.reply(m.chat, `*[ 💠 ] 𝚃𝚞𝚜 𝚍𝚒𝚊𝚖𝚊𝚗𝚝𝚎𝚜 𝚜𝚎 𝚑𝚊𝚗 𝚊𝚐𝚘𝚝𝚊𝚍𝚘.*\n\n*⚕️.- 𝙿𝚞𝚎𝚍𝚎𝚜 𝚑𝚊𝚌𝚎𝚛 𝚞𝚗𝚊 𝚌𝚘𝚖𝚙𝚛𝚊 𝚞𝚝𝚒𝚕𝚒𝚣𝚊𝚗𝚍𝚘 𝚎𝚕 𝚜𝚒𝚐𝚞𝚒𝚎𝚗𝚝𝚎 𝚌𝚘𝚖𝚊𝚗𝚍𝚘: ${usedPrefix}buy <cantidad>*`, m);
          continue; // Limit habis
        }
        if (plugin.level > _user.level) {
          this.reply(m.chat, `*[ 💠 ] 𝚁𝚎𝚚𝚞𝚒𝚎𝚛𝚎𝚜 𝚞𝚗 𝚗𝚒𝚟𝚎𝚕 𝚍𝚎 ${plugin.level} 𝚙𝚊𝚛𝚊 𝚙𝚘𝚍𝚎𝚛 𝚞𝚝𝚒𝚕𝚒𝚣𝚊𝚛 𝚎𝚜𝚝𝚎 𝚌𝚘𝚖𝚊𝚗𝚍𝚘.*\n\n*𝚃𝚞 𝚗𝚒𝚟𝚎𝚕 𝚊𝚌𝚝𝚞𝚊𝚕 𝚎𝚜: ${_user.level}*`, m);
    ...
    case 'remove':
      if (chat.welcome) {
        ...
        for (const user of participants) {
          let wel = 'https://telegra.ph/file/ce02ae460707be61fcfc5.jpg';
          let byes = 'https://telegra.ph/file/650c9336ee8de0c8fe581.jpg';
          try {
      wel = 'https://telegra.ph/file/ce02ae460707be61fcfc5.jpg'
          } finally {
...
this.sendFile(id, action === 'add' ? wel : byes, 'pp.jpg', text, null, false, { mentions: conn.parseMention(text) })
  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;ඞ 𝐿.𝐴𝑛 ༆;;;\nFN:ඞ 𝐿.𝐴𝑛 ༆\nORG:ඞ 𝐿.𝐴𝑛 ༆\nTITLE:\nitem1.TEL;waid=5219992095479:+521 999 209 5479\nitem1.X-ABLabel:ඞ 𝐿.𝐴𝑛 ༆\nX-WA-BIZ-DESCRIPTION:[ 💠 ] 𝚂𝚘𝚕𝚘 𝚙𝚊𝚛𝚊 𝚌𝚘𝚜𝚊𝚜 𝚒𝚖𝚙𝚘𝚛𝚝𝚊𝚗𝚝𝚎𝚜.\nX-WA-BIZ-NAME:ඞ 𝐿.𝐴𝑛 ༆\nEND:VCARD`;
        await this.sendMessage(nk.from, {contacts: {displayName: 'ඞ 𝐿.𝐴𝑛 ༆', contacts: [{vcard}]}}, {quoted: callmsg});
...
global.dfail = (type, m, conn) => {
  const msg = {
    rowner: '*[ 💠 ] 𝙴𝚜𝚝𝚎 𝚌𝚘𝚖𝚊𝚗𝚍𝚘 𝚜𝚘𝚕𝚘 𝚙𝚞𝚎𝚍𝚎 𝚜𝚎𝚛 𝚞𝚝𝚒𝚕𝚒𝚣𝚊𝚍𝚘 𝚙𝚘𝚛 𝚎𝚕 𝚙𝚛𝚘𝚙𝚒𝚎𝚝𝚊𝚛𝚒𝚘 𝚍𝚎𝚕 𝚋𝚘𝚝.*',
    owner: '*[ 💠 ] 𝙴𝚜𝚝𝚎 𝚌𝚘𝚖𝚊𝚗𝚍𝚘 𝚜𝚘𝚕𝚘 𝚙𝚞𝚎𝚍𝚎 𝚜𝚎𝚛 𝚞𝚝𝚒𝚕𝚒𝚣𝚊𝚍𝚘 𝚙𝚘𝚛 𝚎𝚕 𝚙𝚛𝚘𝚙𝚒𝚎𝚝𝚊𝚛𝚒𝚘 𝚍𝚎𝚕 𝚋𝚘𝚝.*',
    mods: '*[ 💠 ] 𝙴𝚜𝚝𝚎 𝚌𝚘𝚖𝚊𝚗𝚍𝚘 𝚜𝚘𝚕𝚘 𝚙𝚞𝚎𝚍𝚎 𝚜𝚎𝚛 𝚞𝚝𝚒𝚕𝚒𝚣𝚊�