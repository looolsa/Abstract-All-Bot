...
const handler = async (m, {conn, args, command, usedPrefix, text}) => {
  ...
  if (!args[0]) throw `*[ 💠 ] Ingresa un enlace de xvideos para proceder con la descarga.*\n\n_⚕️.- Ejemplo:_ *${usedPrefix + command} https://www.xvideos.com/video70389849/pequena_zorra_follada_duro*`;
  try {
    conn.reply(m.chat, '*[ 💠 ] El video será enviado en unos instantes...*', m);
